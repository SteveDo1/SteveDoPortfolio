        ...
        <div>
          <Reveal>
            <p className={`${styles.aboutText}`}>
              Hey! I&apos;m Steve, if you haven&apos;t already gathered that by
          ...
          <Reveal>
            <p className={styles.aboutText}>
              I currently work for BlackBerry as a Junior Cyber Forensics Analyst Intern. I also toss in my ¢2
          ...
          <Reveal>
            <p className={styles.aboutText}>
              Outside of work, you can find me exploring new technologies, building custom keyboards, or playing games. 
              Any given Sunday
